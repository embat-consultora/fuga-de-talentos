...
11	2025-05-23 16:26:24.374451+00	\N	44	1	PENINSULA	HRP30000004741	MARTIN PEREZ, JUAN	JUANMARTIN1964RIENDA@GMAIL.COM	659139159.0	Iberostar Málaga Playa	BAR/RESTAURANTE	2º JEFE/A BR	1964-01-04	1997-04-08	Supera_110%	Guada	f	f	f	f	f	f	\N
...
57	2025-06-23 17:41:40.764893+00	21	45	Fernando tiene 48 años de edad, es oriundo de Sevilla. Se formó como Aparejador. Le gustaría estudiar Economía, para comprender más acerca de la gestión del negocio, aunque no encuentra aún el momento para ello. 	Sobre su recorrido laboral comparte que trabajó durante un mes y medio en la cadena El Faro de Fuerteventura, y en el año 2009 ingresó a Iberostar. Comenzó como Lavaplatos, avanzó a Camarero y se convirtió en 2°Jefe de Bares y Restaurantes.	23/06/2025			-\tAumentar la estrategia en la resolución, considerando los intereses del negocio, para establecer prioridades y dimensionar consecuencias, habilitando a un desempeño más eficiente y alineado al negocio. \n-\tAsumir un rol más proactivo ante las oportunidades de proponer en pos del cambio. Atreverse a cuestionar lo establecido, para evidenciar ingenio ante oportunidades de mejora\n	- Permitir mayor exposición, debido a que algunos desvíos en las decisiones o propuestas, son consecuencia de desconocimiento acerca de la estrategia y de las prioridades del negocio. \n- Brindar formaciones ante las habilidades o áreas que Fernando necesite desarrollar, debido a que logra detectar de sí mismo oportunidades de mejora con objetividad, lo que lo posiciona con apertura para el aprendizaje. 	Fernando demuestra un elevado sentido de pertenencia con la compañía. Es una persona accesible para el relacionamiento, que disfruta de acompañar a clientes internos y externos ante sus necesidades para su satisfacción. Necesita conservar la estrategia y el orden, para beneficiar al negocio y cumplir objetivos de manera ordenada. También, podría elevar su protagonismo al realizar propuestas, evitando conformarse sencillamente con lo conocido y establecido. 	Bajo				Total		No posee inconvenientes para protagonizar un movimiento geografico. Tampoco informa sobre preferencias acerca del mismo, mostrando accesibilidad ante cualquier alternativa.	3		
56	2025-06-23 10:10:02.293288+00	11	44	No tiene una formación académica luego de la formación Escolar.	Inició su trayectoria profesional en 1981 con contratos de temporada en diferentes establecimientos, como Adarhol, S.A., Minorica Hotelera, Hotel Indálico y Cía Hotelera Nerja, desarrollando funciones vinculadas a la atención al cliente y operaciones hoteleras. A lo largo de los años 80 y 90, continuó trabajando en diversos hoteles de la Costa del Sol y Baleares, acumulando experiencia en recepción, reservas y atención al público.\nEntre 1998 y 2011, prestó servicios de forma intermitente en Riusa II, S.A., destacándose por su continuidad y desempeño durante múltiples temporadas. Desde 2011, ha estado vinculada de manera constante al grupo Iberostar Management, S.A.U., desarrollando su carrera principalmente en el Hotel Iberostar Waves Málaga Playa. A lo largo de más de una década ha renovado su compromiso cada temporada, asumiendo responsabilidades crecientes que la llevaron a desempeñar actualmente el cargo de Segundo Jefe de Recepción.	23/06/2025			No se recomienda su promoción	Si bien no tiene aspiraciones de desarrollo, podría ser beneficioso  participar en programas que fomenten habilidades para motivar, dar feedback constructivo y adaptar el estilo comunicacional según el interlocutor.	Tiene un enfoque operativo y responsable, con una marcada disposición a cumplir con los lineamientos organizacionales y asegurar el funcionamiento correcto de los procesos. Asume sus tareas con compromiso y es capaz de responder con eficacia ante situaciones concretas o demandas puntuales, mostrando especial atención al uso eficiente de los recursos y al cumplimiento de los estándares establecidos.\nSin embargo, se evidencian áreas de mejora significativas vinculadas a la proyección estratégica, el liderazgo inspirador y la construcción de vínculos colaborativos más horizontales. Su estilo tiende a ser correctivo y directivo, con una comunicación clara pero poco adaptable a distintos contextos, lo cual puede limitar el desarrollo de relaciones laborales fluidas y la apertura a la diversidad de opiniones. Además, si bien demuestra alineación con las políticas institucionales —como las vinculadas a la sostenibilidad—, su accionar carece de proactividad, mostrando más una actitud de cumplimiento que de liderazgo en dichas temáticas.\n	Bajo				Nula		Ya no busca reubicarse o trasladarse a otros destinos o funciones, entendiendo que cada etapa profesional tiene su momento. En este sentido, sus expectativas están orientadas a mantener la estabilidad, aportar desde su experiencia y cuidar el equilibrio entre lo laboral y lo personal.	3		
...
113	2025-06-23 10:36:19.549106+00	Liderazgo	Le falta desarrollar un liderazgo inspirador y una actitud más abierta al disenso. Tiende a adoptar un estilo correctivo y directivo que limita la construcción de vínculos colaborativos horizontales.	56	11
...
114	2025-06-23 10:36:19.722725+00	Eficiencia y eficacia 	Debe mejorar la planificación y capacidad de anticiparse en la medida que adquiera responsabilidades de complejidad creciente	56	11
124	2025-06-23 18:22:22.791478+00	Sostenibilidad	No genera dudas sobre su compromiso con la sostenibilidad, aunque podría ser más proactivo al cuestionar prácticas establecidas, en pos de la mejora continua. Necesita aumentar su protagonismo respecto a las oportunidades de cambio, para generar un impacto mayor con su gestión y en el equipo. 	57	21
...
123	2025-06-23 18:22:22.600456+00	Eficiencia y eficacia 	Podría lograr una organización aún más estratégica contemplando las prioridades e intereses del negocio frente a escenarios de mayor abstracción y ambigüedad, es decir, ante proyectos que excedan a la organización operativa. También, podría aumentar la reflexión para dimensionar consecuencias en la resolución, debido a que tiende a dejarse llevar por la intuición, lo que provocaría, eventualmente, algunos desvíos de lo esperado por la compañía, a pesar de que no se duda sobre su compromiso y responsabilidad.	57	21
\.
...
91	2025-06-23 10:36:20.081109+00	34	A nivel profesional, se encuentra en una etapa de estabilidad y madurez laboral. Se siente a gusto en su puesto actual como segundo en el hotel Málaga Playa y no tiene intención de asumir nuevas responsabilidades fuera de esta unidad. Valora la experiencia adquirida, el conocimiento del entorno y su rol dentro del equipo, y considera que es momento de consolidar lo construido más que buscar nuevos desafíos.\nReconoce que el hotel opera con una dotación de personal más ajustada que otros establecimientos, lo cual genera desgaste en el equipo y afecta la continuidad operativa, sobre todo ante bajas. No obstante, ha aprendido a adaptarse a las políticas de la empresa, manteniendo una actitud profesional y comprometida con el servicio. Se define como un buen profesional, que disfruta de su trabajo y sabe identificar cuándo es necesario poner límites y priorizar el bienestar personal.\n	56	11	
98	2025-06-23 18:22:23.127774+00	28	Se proyecta hasta su madurez profesional en Iberostar, es decir, se visualiza como parte de la compañía hasta su retiro laboral. Expone que su ADN es Iberostar debido a que la empresa le ha dado todo, la posibilidad de tener estabilidad económica, y también de generar los vínculos más importantes de su vida, debido a que formó familia en Iberostar y su grupo de amigos son  personas integrantes del negocio. Considera a Iberostar como su propio negocio, en el sentido de que se ve afectado con el éxito o con las dificultades que el mismo atraviesa.\n \nLe gustaría protagonizar un crecimiento dentro del Departamento de Bares y Restaurantes. Si bien no se encuentra cerrado ante ninguna alternativa, no existe otro Departamento que llame su atención, exponiendo sobre su pasión por los temas que abarca. Sus referentes dentro del negocio son perfiles de Dirección, a quienes admira por su destreza en la toma de decisiones en relación al negocio. \n\nEspera formarse en relación a informática y sobre Economía, para sentirse más profesional ante la posibilidad de afrontar retos futuros. \n	57	21	
\.
...
139	2025-06-23 10:36:19.211971+00	Colaboración	Muestra un fuerte sentido de pertenencia y cumple con las políticas y lineamientos establecidos, especialmente en sostenibilidad y estándares operativos.	56	11
...
144	2025-06-23 18:22:22.275265+00	Excelencia con el cliente	Disfruta del contacto con el cliente, mostrándose amable y disponible ante las necesidades. Adecua el servicio en todo lo que esté a su alcance, con el propósito de generar una positiva experiencia y fidelizar a cada visitante. Intenta transmitir a los demás integrantes del negocio la importancia de responder a los intereses de clientes, para que se sientan parte de la familia Iberostar.	57	21
...
482	2025-06-23 18:22:19.700141+00	1	21	4	57
483	2025-06-23 18:22:19.865053+00	4	21	1	57
...
466	2025-06-23 10:36:17.681556+00	1	11	4	56
467	2025-06-23 10:36:17.848194+00	4	11	1	56
\.
...
549	2025-06-23 18:22:21.077884+00	Necesita mayor organización para priorizar las tareas con sentido estratégico. En ocasiones podría ser más intuitivo y pasional que reflexivo. Si bien se implica en la gestión del negocio, cuidando los recursos de la compañía como si fuesen propios, con gran sentido de responsabilidad, las soluciones que propone, eventualmente, no se alinean a los intereses o permisos de la empresa, lo que reconoce con objetividad sobre sí mismo. No genera dudas de su organización operativa, para llevar adelante las tareas sencillas diarias de manera prolija, lo que se considera oportunidad de mejora se relaciona con el planeamiento ante escenarios de mayor complejidad y abstracción, en los que debería priorizar lo relativo a los intereses del negocio. Es capaz de adaptarse a los cambios con facilidad, aunque se considera, necesita ser más proactivo ante la posibilidad de proponer mejoras, para lo que debe cuestionar lo establecido con mayor audacia.	21	Eficiencia y eficacia 	1	57	2025
...
551	2025-06-23 18:22:21.673527+00	Desde la perspectiva de Fernando no existen negativas ante las necesidades o solicitudes de clientes. Es una persona servicial, que tiene en cuenta la experiencia del cliente al momento de tomar decisiones, y que logra empatizar con el mismo en todos los casos. Se comunica con amabilidad, mostrando vocación de servicio en toda la dinámica. Como aspecto de mejora, podría anticiparse más ante posibles requerimientos futuros, lo que no se asocia al desinterés en su caso, sino a una solución exclusiva post demanda explicita. También, debe evitar desconsiderar los intereses del negocio, por la atención que brinda al cliente, conservando un enfoque comercial, a pesar de su elevada disponibilidad para los huéspedes. 	21	Excelencia con el cliente	4	57	2025
...
519	2025-06-23 10:36:18.182612+00	El liderazgo se presenta como una necesidad de mejora. Si bien se evidencia una disposición a asumir responsabilidades y tomar decisiones, aún es posible ganar mayor seguridad y claridad en la dirección que se brinda al equipo. Existe margen para fortalecer la capacidad de inspirar a los demás a través del ejemplo, la motivación y una energía positiva constante, elementos clave para generar cohesión y compromiso.\nLa adaptación a cambios del entorno o dinámicas grupales también es un área de mejora, debiendo desarrollar una mayor agilidad emocional y operativa ante lo imprevisto, y ante las situaciones con las que no esté de acuerdo.	11	Liderazgo	1	56	2025
520	2025-06-23 10:36:18.352792+00	Muestra un perfil operativo, con capacidad para responder de forma concreta ante problemas y ofrecer soluciones de corto plazo, aún se observa una limitada proyección estratégica en la organización y priorización de tareas.\nSe enfoca en su trabajo, y en responder a las demandas externas con una visión de corto plazo.\nTiende a enfocarse en resolver lo inmediato con eficacia, cuidando los recursos disponibles y cumpliendo con los tiempos establecidos sin comprometer la calidad. Sin embargo, para evolucionar hacia un desempeño más integral, sería valioso fortalecer la planificación con visión a mediano y largo plazo, y alinear las acciones con los objetivos generales del equipo.\nSi bien es capaz de detectar errores y asumir responsabilidad sobre ellos, así como identificar oportunidades de mejora durante la ejecución, aún puede potenciar su capacidad de análisis para anticiparse a los problemas y liderar iniciativas de mejora continua más estructuradas.	11	Eficiencia y eficacia 	2	56	2025
522	2025-06-23 10:36:18.69761+00	Colabora con los objetivos conjuntos del área, asistiendo a otros en situaciones de mayor demanda laboral, dado que responde con responsabilidad ante sus compromisos. Si bien demuestra una escucha respetuosa, especialmente en interacciones con nuevos contactos, puede mostrar cierta impaciencia ante opiniones que difieren de las propias, lo que limita la apertura al intercambio y la construcción conjunta.\nTiene disposición para ayudar al equipo, aunque suele adoptar una postura más correctiva y directiva, lo que puede dificultar la generación de un entorno más colaborativo y horizontal. Su comunicación es clara y efectiva, pero responde a un estilo muy personal.\nDesarrollar una mayor flexibilidad comunicacional y apertura al disenso fortalecerá significativamente su capacidad para colaborar de manera más efectiva y generar relaciones laborales más fluidas y constructivas.	11	Colaboración	2	56	2025
...
521	2025-06-23 10:36:18.520871+00	Si bien se relaciona de manera frontal y transparente, su disposición a brindar un servicio de calidad varía en función del vínculo personal con el cliente. Cuando siente afinidad, se muestra muy servicial y mantiene una actitud positiva; sin embargo, si esto no ocurre, tiende a limitar el esfuerzo por interactuar o generar una experiencia satisfactoria.\nA pesar de esta variabilidad en el trato, demuestra una preocupación real por asegurar que el servicio funcione correctamente y que los procesos se alineen con los estándares de calidad establecidos. Para fortalecer su desempeño en esta competencia, sería importante desarrollar una actitud más empática y profesional en todos los vínculos con clientes, independientemente de las afinidades personales, poniendo siempre en primer plano las necesidades del cliente y la imagen de la organización.\n	11	Excelencia con el cliente	2	56	2025
523	2025-06-23 10:36:18.863002+00	Muestra una conciencia clara respecto a la importancia de integrar criterios de sostenibilidad en su trabajo cotidiano, buscando un equilibrio entre la eficiencia operativa y el uso responsable de los recursos. Si bien su enfoque no es especializado en la temática, y no traerá propuestas que optimicen las mismas, demuestra una fuerte afiliación por la Organización, por lo que asume con responsabilidad estas políticas. en este sentido procura implementar las pautas y normas establecidas, y hacer que los demás las cumplan.	11	Sostenibilidad	2	56	2025
547	2025-06-23 18:22:20.477376+00	Lo más complejo de su puesto se relaciona con los limites que debe plantear en algunas circunstancias a los integrantes del equipo, como así también la toma de decisiones impopulares, las cuales tienen un impacto negativo en los demás. Necesita mayor seguridad para tomar decisiones que resulten necesarias e importantes para el negocio. No se siente a gusto con la imagen de Jefe, sino más bien con un estilo de liderazgo accesible, caracterizado por la cercanía y la empatía. Busca realizar asignaciones en función de las circunstancias y de las particularidades de cada talento. Resulta clave desde su perspectiva que los recursos sean buenas personas y buenos compañeros, debido a que según su opinión todo lo demás puede aprenderse y moldearse. Confía en todas las personas sin distinción, lo que en ocasiones podría ser contraproducente y generar algunas confusiones ante perfiles que se atrevan a tomarse atribuciones más excesivas de lo que deberían. Intenta transmitir continuamente una energía positiva, priorizando la cohesión de equipo y la colaboración en todos los casos. Es una persona ágil para adaptarse a los cambios del entorno o de la dinámica. 	21	Liderazgo	3	57	2025
...
548	2025-06-23 18:22:20.638857+00	Se muestra siempre dispuesto a ayudar y a construir en conjunto. Respeta las diversas miradas y opiniones, con la apertura necesaria para validar la diferencia. Escucha atentamente a los demás, habilitando el espacio para ello. Desde su lugar, predica la confianza y la cooperación, como así también los acuerdos y el consenso, para generar ganancias comunes que les permita a todos los integrantes del negocio preservar sus intereses. Evita los canales alternativos de comunicación, que en vez de facilitar al intercambio directo, generan distancia y confusión. Podría aumentar la claridad al comunicar, debido a que en ocasiones, podría ser demasiado indirecto para trasmitir lo que necesita. También, su mensaje es algo extenso, lo que provoca reducida concreción y por ende, perdida del enfoque sobre lo que busca comunicar. 	21	Colaboración	3	57	2025
550	2025-06-23 18:22:21.506571+00	Fernando muestra sensibilidad hacia el impacto ambiental y social, y promueve el uso responsable de los recursos disponibles. No obstante, podría asumir un rol más protagónico al cuestionar prácticas poco sostenibles, para proponer alternativas evidenciando mayor ingenio. Asume una postura adaptable, aunque conformista con lo establecido. Podría ser aún más influyente en su equipo, para generar un impacto mayor en lo que refiere a sostenibilidad desde su lugar. No genera dudas sobre su compromiso con el World of Change, aunque necesita mayor proactividad en consonancia.	21	Sostenibilidad	2	57	2025
\.
...
SELECT pg_catalog.setval('"public"."areaDesarrollo_id_seq"', 124, true);
...
SELECT pg_catalog.setval('"public"."idiomaNiveles_id_seq"', 483, true);
...
SELECT pg_catalog.setval('"public"."informeAspiraciones_id_seq"', 98, true);
...
SELECT pg_catalog.setval('"public"."informeFortalezas_id_seq"', 144, true);
...
SELECT pg_catalog.setval('"public"."informeValoracionCompetencia_id_seq"', 551, true);
...
SELECT pg_catalog.setval('"public"."informe_id_seq"', 57, true);
