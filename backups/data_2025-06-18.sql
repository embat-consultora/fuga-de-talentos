...
114	2025-05-24 09:52:24.442197+00	\N	\N	\N	Canarias	HRP30000002848	MARTIN RODRIGUEZ, MARIA TERESA	MAITECARACAS2@GMAIL.COM	\N	Iberostar Las Dalias	Pisos	2º JEFE/A PISOS	1975-03-07	2015-06-08	Excelente_120%	\N	f	f	f	f	f	f	España
...
82	2025-06-17 19:12:03.823837+00	Sostenibilidad	Podría ser más proactivo y disruptivo al proponer, para lo que necesitará cuestionar lo funcional para identificar posibles mejoras. Fomenta el cuidado de los recursos, mostrando sensibilidad hacia el impacto ambiental, aunque no cuestiona las prácticas que podrían cambiarse, conformándose con lo establecido y conocido.	44	22
83	2025-06-17 19:12:04.015629+00	Liderazgo	Necesita ser más firme al comunicar y seguro al decidir, debido a que su estilo empático y accesible puede vincularse a la extrema flexibilidad y docilidad. Reconoce su complemento con perfiles más directos, que informan y asignan sin rodeos.  	44	22
...
410	2025-06-17 19:12:01.261213+00	1	22	3	44
411	2025-06-17 19:12:01.463052+00	4	22	3	44
412	2025-06-17 19:12:01.640833+00	11	22	3	44
413	2025-06-17 19:12:01.832995+00	12	22	3	44
414	2025-06-18 10:48:25.150185+00	1	10	4	46
...
394	2025-06-16 17:00:00.679026+00	1	48	1	42
395	2025-06-16 17:00:00.823552+00	12	48	1	42
...
COPY "public"."nivelesCompetencias" ("id", "created_at", "nombre", "lang", "order", "colorId") FROM stdin;
6	2025-05-09 09:20:56.016801+00	Development Need	en	1	\N
7	2025-05-09 09:21:05.211997+00	Development Opportunity	en	2	\N
8	2025-05-09 09:21:11.900353+00	Competent	en	3	\N
9	2025-05-09 09:21:17.725833+00	Strength	en	4	\N
10	2025-05-09 09:21:27.013844+00	Role Model	en	5	\N
11	2025-05-09 09:21:53.863597+00	Necessidade de desenvolvimento	pt	1	\N
12	2025-05-09 09:22:03.152656+00	Oportunidade de desenvolvimento	pt	2	\N
13	2025-05-09 09:22:11.222288+00	Competente	pt	3	\N
14	2025-05-09 09:22:20.20891+00	Ponto forte	pt	4	\N
15	2025-05-09 09:22:28.935882+00	Modelo a ser seguido	pt	5	\N
1	2025-05-09 09:19:00.058169+00	Necesidad de desarrollo	es	1	3
2	2025-05-09 09:19:10.578465+00	Oportunidad de Desarrollo	es	2	2
3	2025-05-09 09:19:32.949199+00	Competente	es	3	1
4	2025-05-09 09:19:40.639119+00	Punto Fuerte 	es	4	1
5	2025-05-09 09:19:49.550314+00	Modelo a seguir	es	5	1
\.
...
SELECT pg_catalog.setval('"public"."areaDesarrollo_id_seq"', 83, true);
...
SELECT pg_catalog.setval('"public"."competencias_id_seq"', 15, true);
...
SELECT pg_catalog.setval('"public"."idiomaNiveles_id_seq"', 414, true);
...
SELECT pg_catalog.setval('"public"."informeAspiraciones_id_seq"', 83, true);
...
SELECT pg_catalog.setval('"public"."informeFortalezas_id_seq"', 111, true);
...
SELECT pg_catalog.setval('"public"."informeValoracionCompetencia_id_seq"', 407, true);
...
SELECT pg_catalog.setval('"public"."informe_id_seq"', 46, true);
